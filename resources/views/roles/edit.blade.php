...
@section('content_header')
    <div class="container-fluid">
        <div class="row">
            <div class="col">
                <h1 class="text-dark">Alterar Grupo:</h1>
            </div>
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('roles.update', ['role' => $role->id]) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('name') is-invalid @enderror" id="groupName" name="name" value="{{ $role->name }}" aria-describedby="groupHelp" required>
                        ...
                        <div class="form-group">
                            ...
                            @foreach ($permissions as $permission)
                                ...
                                <div class="form-check">
                                    <input class="form-check-input @error('permissions') is-invalid @enderror" type="checkbox" id="{{ Str::kebab($permission['name']) }}" name="permissions[]" value="{{ $permission['name'] }}" {{ $permission['checked'] ? 'checked' : null }}>
